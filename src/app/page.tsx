    ...
    <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
      <div className="mb-12 px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="mt-2 font-bold text-4xl tsxt-gray-900 sm:text-5xl">Start Chatting with your documents in minutes</h2>
      ...
      <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:pt-4">
            ...
            <span className="mt-2 text-zinc-700">We&apos;ll process your file and make ready for you to chat with.</span>
          </div>
        </li>
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-1-0 md:border-t-2 md:pb-0 md:pt-4">
